...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "authentication_user_id_fkey", "authentication", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "authentication", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("permissions_role_id_fkey", "permissions", type_="foreignkey")
    op.create_foreign_key(
        None, "permissions", "roles", ["role_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "permissions_role_id_fkey", "permissions", "roles", ["role_id"], ["id"]
    )
    op.drop_constraint(None, "authentication", type_="foreignkey")
    op.create_foreign_key(
        "authentication_user_id_fkey", "authentication", "users", ["user_id"], ["id"]
    )
